            ...
            <div className="flex items-center gap-3">
                <div className="relative">
                    <input
                        ...
                        className='w-full px-4 py-2 text-sm rounded-md bg-white text-[#9D201B] border border-transparent placeholder:text-[#9D201B] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#9D201B] focus:border-[#9D201B]'
                    />
