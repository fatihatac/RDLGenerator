                ...
                {reportItems.length === 0 ? (
                    ...
                    <div className="space-y-6">
                        {reportItems.map((item) => (
                            <div key={item.id}>
                                {item.type === 'title' && <TextboxEditor item={item} />}
                                {item.type === 'table' && <TableEditor item={item} />}
                                {item.type === 'data' && <JSONEditor item={item} />}
                                {item.type === 'dateRange' && <DateRangeEditor item={item} />}
                            </div>
                        ))}
                    </div>
                )}
