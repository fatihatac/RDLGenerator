function buildDataSet(dataItem, tableItem, dataSetName) {
  ...
  //     "@_Name": dataSetName,
  //     Fields: {
  //       Field: dataItem.jsonKeys.map(key => {
  //         const mappedCol = tableItem.columns.find(c => c.mappedField === key);
  //         return {
  //           "@_Name": key,
  //           DataField: key,
  //           "rd:TypeName": mappedCol?.dataType || "System.String"
  //         };
  //       })
  //     },
  //     Query: {
